...
\"\n\
checkout_executable TCLSH \"/home/Noureddine/ns-allinone-2.35-RC7/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/Noureddine/ns-allinone-2.35-RC7/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
\n\
Agent/Aspu set accessible_var_ true\n\
